...
exports.shouldRefetchParticipant = exports.errorMessages = void 0;
...
var shouldRefetchParticipant = function (error) {
    return (error === exports.errorMessages.discord_unauthenticated ||
        error === exports.errorMessages.telegram_unauthenticated ||
        error === exports.errorMessages.twitter_unauthenticated);
};
exports.shouldRefetchParticipant = shouldRefetchParticipant;
