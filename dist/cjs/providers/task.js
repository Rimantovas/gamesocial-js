...
var useTask = function () { return (0, react_1.useContext)(context); };
exports.useTask = useTask;
function TaskProvider(_a) {
    var children = _a.children, state = _a.state, errorCallback = _a.errorCallback;
    // eslint-disable-next-line react-hooks/rules-of-hooks
    state !== null && state !== void 0 ? state : (state = (0, exports.useTaskState)(errorCallback));
    return (0, jsx_runtime_1.jsx)(context.Provider, { value: state, children: children });
}
exports.TaskProvider = TaskProvider;
var useTaskState = function (errorCallback) {
    var _a = (0, react_1.useState)(false), isParticipationLoading = _a[0], setIsParticipationLoading = _a[1];
    var updateTaskStatus = (0, missions_1.useMissions)().updateTaskStatus;
    var _b = (0, participant_1.useParticipant)(), addPoints = _b.addPoints, getParticipant = _b.getParticipant;
    ...
    var handleError = function (e) {
        ...
        if (!message) {
            ...
            if (message in errors_1.errorMessages) {
                var s = (0, errors_1.shouldRefetchParticipant)(message);
                if (s) {
                    // TODO Maybe await this
                    getParticipant();
                }
                errorCallback && errorCallback(errors_1.errorMessages[message]);
            }
            else {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2: return [4 /*yield*/, api()
                        ...
                        if (response.data.status === participants_enum_1.ParticipantTaskStatus.completed &&
                            task.points_reward) {
                            addPoints(task);
                        }
                        if (callback) {
